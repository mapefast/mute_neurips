...
% Description:
% 
% Overwrite the nearNeiFirstTermCondEnt.m by this function to apply the LA
% method for ranking candidate vectors. The only difference with the former
% is at line 122-127, in which the idMin redirects to the maximum LA criterion 
% rather than the original Conditional Mutual Information.
%%
% Input:
% 
...
%         evaluating the conditional mutual information        
        ...
        maxMutualInfoValues(1,z+1)           = conditionalInfo(1,z);
